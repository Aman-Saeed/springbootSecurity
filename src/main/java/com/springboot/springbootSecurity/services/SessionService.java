...
import com.springboot.springbootSecurity.repositories.SessionRepository;
...
public class SessionService {
    ...
    public void validateSession(String refreshToken){
        Session session = sessionRepository.findByRefreshToken(refreshToken)
                .orElseThrow(()-> new SessionAuthenticationException("Invalid session. Please log in again."));
